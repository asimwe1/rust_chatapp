...
function init() {
  ...
  addRoom("dbot");
  changeRoom("lounge");
  addMessage("lounge", "dbot", "Hey! Open another browser tab, send a message.", true);
  addMessage("lounge", "dbot", "you will be getting updates from here", true);
  addMessage("dbot", "dbot", "This is another room. Neat, huh?", true);
  addMessage("dbot", "dbot", "feel free the ask me something as i am your chat assistant", true);

  //the form handler set up.
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room, "dbot", `Look, your own "${room}" room. Nice huh!`, true);
  })
